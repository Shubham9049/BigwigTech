...
const systems = [
  {
    id: "01",
    title: "Coaching & training apps",
    description:
      "Programmes, workouts and progress tracking with the engagement design that beats week-three churn.",
  },
  {
    id: "02",
    title: "Wearable & health integration",
    description:
      "First-class HealthKit, Google Fit and device integrations so the data users already have just works.",
  },
  {
    id: "03",
    title: "Gym & studio platforms",
    description:
      "Membership, booking, payments and class management for gyms, studios and trainers.",
  },
  {
    id: "04",
    title: "Connected fitness hardware",
    description:
      "App-plus-device experiences for connected equipment, with real-time metrics and sync.",
  },
  {
    id: "05",
    title: "Community & habit",
    description:
      "Challenges, streaks, leaderboards and social features that turn solo effort into a sticky routine.",
  },
  {
    id: "06",
    title: "Coaching & content delivery",
    description:
      "Live and on-demand classes, plans and creator content delivered smoothly on every device.",
  },
];
...
const outcomes = [
  {
    value: "HealthKit · Fit",
    label: "Wearable data, first-class",
  },
  {
    value: "Real-time",
    label: "Sync across phone, watch, web",
  },
  {
    value: "Habit-led",
    label: "Designed for retention",
  },
  {
    value: "Personal",
    label: "Adaptive coaching & nudges",
  },
];
...
const principles = [
  {
    id: "01",
    title: "Retention is the metric",
    description:
      "We design for the return visit, not the install — habit loops, streaks and timing tuned to keep people coming back.",
  },
  {
    id: "02",
    title: "Meet the data where it lives",
    description:
      "HealthKit and Google Fit are first-class, so users’ existing watch and wearable data flows in from day one.",
  },
  {
    id: "03",
    title: "Real-time across devices",
    description:
      "Workouts, metrics and progress stay in sync across phone, watch and web without the user thinking about it.",
  },
  {
    id: "04",
    title: "Coaching that feels personal",
    description:
      "Programmes and nudges adapt to the individual, because generic plans are the fastest route to churn.",
  },
];
const audiences = [
...
const nextIndustry = {
  number: "13",
  total: "15",
  title: "OTT Plantforms ",
  href: "/industries/ott-platforms",
};

const faqs = [
  [
    "Do you integrate with Apple Health and Google Fit?",
    "Yes — HealthKit and Google Fit are first-class integrations, so the wearable and health data users already have flows in from day one.",
  ],
  [
    "Can you build for connected fitness hardware?",
    "We build app-plus-device experiences for connected equipment, with real-time metrics and cross-device sync.",
  ],
  [
    "How do you tackle retention?",
    "We design habit loops, streaks, challenges and adaptive coaching tuned to the return visit — because week-three retention is what fitness products live or die on.",
  ],
  [
    "Can you handle gym and studio operations too?",
    "Membership, booking, payments and class management for gyms, studios and trainers are part of what we deliver.",
  ],
  [
    "Can you deliver live and on-demand classes?",
    "Yes — live and on-demand class delivery, plans and creator content streamed smoothly across devices are part of the platforms we build.",
  ],
] as const;
      ...
      <section className="industries-hero relative overflow-hidden border-b border-[#d8dce9] px-5 pb-20 pt-8 sm:px-8 lg:px-10">
        ...
        <div className="absolute right-10 top-14 hidden lg:block">
          <div className="flex h-44 w-44 items-center justify-center rounded-[2rem] border border-[#ffb59f] bg-gradient-to-br from-[#ffe7e0] via-white/80 to-[#ffe9e3] shadow-[0_25px_60px_rgba(255,109,80,.12)] backdrop-blur">
            <Dumbbell size={66} strokeWidth={1.8} className="text-[#ff6d50]" />
          </div>
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-[1360px]">
          ...
          <div className="text-[13px] font-medium uppercase tracking-[.18em] text-[#7983a5]">
            ...
            <span className="text-[#ff6d50]">Fitness</span>
          </div>
          ...
          <p className="mt-10 max-w-3xl text-[21px] leading-[1.7] text-[#55607f]">
            Coaching apps, gym platforms and connected fitness products — with
            wearable integration as a first-class citizen and the engagement
          ...
          <div className="grid lg:grid-cols-[1.35fr_.65fr]">
            ...
            <div className="relative p-8 sm:p-12 lg:p-16">
              ...
              <h2 className="max-w-2xl text-[clamp(2.5rem,4.5vw,4.4rem)]  leading-[0.95] tracking-[-0.06em] text-[#111322] dark:text-white">
                A fitness app wins on week
                <br />
                three, not day one.
              </h2>

              <p className="mt-10 max-w-2xl text-[20px] leading-[1.75] text-[#586482] dark:text-[#b8c1da]">
                Anyone can ship a workout tracker; keeping people in it past the
                initial burst is the real engineering and design problem. We
                build wearable integration as a foundation so HealthKit and
                Google Fit data flows in instantly, keep metrics synced in real
                time across watch, phone and web, and design the habit loops,
                challenges and coaching that turn a download into a daily
                routine. Retention is the number we build toward.
              </p>
            </div>
      ...
      <section className="px-5 py-16 sm:px-8 lg:px-10 ">
        <div className="mx-auto grid max-w-[1360px] gap-16 lg:grid-cols-[0.95fr_1.25fr]">
          ...
          <div className="space-y-10 text-[20px] leading-[1.8] text-[#55607f] dark:text-[#b8c1da]">
            <p>
              Fitness software has one brutal metric: retention. The market is
              full of beautifully designed apps that users abandon in week
              three. Winning means meeting people where their data already lives
              — their watch, their ring, their wearable — and giving them a
              reason to return.
            </p>

            <p>
              We build connected-fitness products with{" "}
              <strong className="font-semibold text-[#111322] dark:text-white">
                HealthKit and Google Fit integration as a foundation,
              </strong>{" "}
              real-time sync across devices, and the coaching, habit and
              community design that turns a download into a daily habit.
            </p>

            <p>
              Behind the app, we build the gym, studio and trainer operations —
              membership, booking, payments — so the business side runs as
              smoothly as the workout on screen.
            </p>
          </div>
        </div>
      </section>
