...
const systems = [
  ...
  {
    id: "03",
    title: "Smart fridges & unattended retail",
    description:
...
const outcomes = [
  {
    value: "200+/hr",
    label: "Peak orders handled per kitchen",
  },
  {
    value: "~90%",
    label: "Reduction in shrinkage on smart fridges",
  },
  {
    value: "24/7",
    label: "Unattended retail uptime",
  },
  {
    value: "$10M+",
    label: "Valuation built with FeelEat",
  },
];
...
const principles = [
  ...
  {
    id: "03",
    title: "Hardware + software as one",
    description:
...
const audiences = [
  ...
  "Hospitality groups",
  "Unattended & micro-market retail",
  "Food & beverage brands",
  "Catering & enterprise dining",
];
      ...
      <section className="industries-hero relative overflow-hidden border-b border-[#d8dce9] px-5 pb-20 pt-8 sm:px-8 lg:px-10">
        ...
        <div className="absolute right-10 top-14 hidden lg:block">
          <div className="flex h-44 w-44 items-center justify-center rounded-[2rem] border border-[#ffb59f] bg-gradient-to-br from-[#ffe7e0] via-white/80 to-[#ffe9e3] shadow-[0_25px_60px_rgba(255,109,80,.12)] backdrop-blur">
            <ChefHat size={66} strokeWidth={1.8} className="text-[#ff6d50]" />
          </div>
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-[1360px]">
          ...
          <div className="text-[13px] font-medium uppercase tracking-[.18em] text-[#7983a5]">
            ...
            <span className="text-[#ff6d50]">Restaurants</span>
          </div>
          ...
          <div className="mt-10 inline-flex items-center gap-4 rounded-full border border-[#d8dce9] bg-white/75 px-5 py-3 shadow-sm backdrop-blur">
            ...
            <span className="text-[14px] uppercase tracking-[.18em] text-[#66728f]">
              Industry 01 / 15 — Hospitality &amp; Food Tech
            </span>
          </div>
          ...
          <p className="mt-10 max-w-3xl text-[21px] leading-[1.7] text-[#55607f]">
            Point-of-sale, self-order kiosks, kitchen displays and the
            back-of-house systems behind them — built to hold up at a
            Friday-night rush, not just a demo.
          </p>
          ...
          <div className="grid lg:grid-cols-[1.35fr_.65fr]">
            ...
            <div className="relative p-8 sm:p-12 lg:p-16">
              ...
              <h2 className="max-w-2xl text-[clamp(2.5rem,4.5vw,4.4rem)]  leading-[0.95] tracking-[-0.06em] text-[#111322] dark:text-white">
                The busiest night is the only
                <br />
                test that counts.
              </h2>

              <p className="mt-10 max-w-2xl text-[20px] leading-[1.75] text-[#586482] dark:text-[#b8c1da]">
                Hospitality software earns its keep at peak, and that is exactly
                when most of it cracks. We engineer for the Friday-night rush
                from the start: kiosks and kitchen displays load-tested to your
                worst-case order volume, terminals that keep taking payments
                through a dropped connection, and a back-of-house that ties
                every order to ingredient cost. We have shipped this for FeelEat
                at a $10M+ valuation — the floor is our spec.
              </p>
            </div>
      ...
      <section className="px-5 py-16 sm:px-8 lg:px-10 ">
        <div className="mx-auto grid max-w-[1360px] gap-16 lg:grid-cols-[0.95fr_1.25fr]">
          ...
          <div className="space-y-10 text-[20px] leading-[1.8] text-[#55607f] dark:text-[#b8c1da]">
            <p>
              Hospitality software lives or dies on two numbers: orders per hour
              and shrinkage. A kiosk that stalls mid-rush, a kitchen display
              that loses a ticket, a fridge that quietly leaks margin — each one
              costs covers and trust in real time, on the busiest night of the
              week.
            </p>

            <p>
              We have shipped the full stack for food businesses — from the{" "}
              <strong className="font-semibold text-[#111322] dark:text-white">
                FeelEat smart "Happy Fridge"
              </strong>{" "}
              with scan-to-unlock and pay-to-open, to self-order kiosks,
              employee apps and the ERP behind them. Offline-first,
              payment-ready, and tuned for the floor rather than the slide deck.
            </p>

            <p>
              The result is a connected operation where every order ties back to
              ingredient cost, every device keeps working through a dropped
              connection, and the people running the venue spend their night on
              guests instead of fighting their tools.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-[1360px] gap-8 md:grid-cols-[.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-5 max-w-sm text-[13px] leading-5 text-[#66728f]">
              The things buyers in restaurants ask us most. Anything else — put
