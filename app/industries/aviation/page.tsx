...
const systems = [
  ...
  {
    id: "06",
    title: "Reliability & safety reporting",
    description:
...
const outcomes = [
  {
    value: "100%",
    label: "Inspection compliance on shipped logbooks",
  },
  {
    value: "3d → 4h",
...
const audiences = [
  ...
  "CAMO organisations",
  "Aviation regulators & authorities",
];
      ...
      <section className="industries-hero relative overflow-hidden border-b border-[#d8dce9] px-5 pb-20 pt-8 sm:px-8 lg:px-10">
        ...
        <div className="absolute right-10 top-14 hidden lg:block">
          <div className="flex h-44 w-44 items-center justify-center rounded-[2rem] border border-[#ffb59f] bg-gradient-to-br from-[#ffe7e0] via-white/80 to-[#ffe9e3] shadow-[0_25px_60px_rgba(255,109,80,.12)] backdrop-blur">
            <Plane size={66} strokeWidth={1.8} className="text-[#ff6d50]" />
          </div>
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-[1360px]">
          ...
          <div className="text-[13px] font-medium uppercase tracking-[.18em] text-[#7983a5]">
            ...
            <span className="text-[#ff6d50]">Aviation</span>
          </div>
          ...
          <p className="mt-10 max-w-3xl text-[21px] leading-[1.7] text-[#55607f]">
            Maintenance, training and operations platforms for aviation —
            EASA/FAA-aware, paperless, and trusted to pass the inspection that
            paper logbooks used to dread.
          </p>
          ...
          <div className="grid lg:grid-cols-[1.35fr_.65fr]">
            ...
            <div className="relative p-8 sm:p-12 lg:p-16">
              ...
              <h2 className="max-w-2xl text-[clamp(2.5rem,4.5vw,4.4rem)]  leading-[0.95] tracking-[-0.06em] text-[#111322] dark:text-white">
                In aviation, the record
                <br />
                is the aircraft.
              </h2>

              <p className="mt-10 max-w-2xl text-[20px] leading-[1.75] text-[#586482] dark:text-[#b8c1da]">
                An aircraft is only as airworthy as its paperwork can prove, and
                that is where software either saves the day or grounds the
                fleet. We design around EASA/FAA obligations from line one:
                tamper-evident logbooks, traceable sign-offs, training matrices
                that track currency, and reporting shaped around the auditor’s
                questions. Aviatize replaced paper end to end and turned a
                three-day audit scramble into a four-hour query across 1,000+
                aircraft.
              </p>
            </div>
      ...
      <section className="px-5 py-16 sm:px-8 lg:px-10 ">
        <div className="mx-auto grid max-w-[1360px] gap-16 lg:grid-cols-[0.95fr_1.25fr]">
          ...
          <div className="space-y-10 text-[20px] leading-[1.8] text-[#55607f] dark:text-[#b8c1da]">
            <p>
              Aviation runs on records. A missed sign-off, an out-of-date
              training matrix, a logbook that can’t be found — and an aircraft
              is grounded or an audit is failed. The cost of a software mistake
              here is measured in days on the tarmac and a regulator’s
              attention.
            </p>
            ...
            <p>
              ...
              , an operations-and-compliance platform that replaced paper
              logbooks end to end and cut audit preparation from three days to
              four hours. We understand the regulatory weight of this sector and
              build for it from line one, not as a feature added late.
            </p>

            <p>
              Every record is tamper-evident, every action is traceable, and
              every report is shaped around the questions an auditor actually
              asks — so compliance becomes a query rather than an annual
              scramble.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-[1360px] gap-8 md:grid-cols-[.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-5 max-w-sm text-[13px] leading-5 text-[#66728f]">
              The things buyers in aviation ask us most. Anything else — put it
