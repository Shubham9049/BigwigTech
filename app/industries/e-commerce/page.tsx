...
const systems = [
  {
    ...
    description:
      "Blazing-fast, SEO-strong storefronts decoupled from the backend so you ship merchandising changes without a redeploy.",
  },
  {
    id: "02",
    title: "Checkout & payments",
    description:
      "Low-friction, multi-method checkout with wallets, BNPL and fraud controls tuned to lift completion.",
  },
  {
    id: "03",
    title: "Marketplaces & multi-vendor",
    description:
      "Seller onboarding, catalogues, payouts and commissions for platforms with many merchants.",
  },
  {
    id: "04",
    title: "Search & merchandising",
    description:
      "Relevance, filters and AI recommendations that surface the right product before the visitor gives up.",
  },
  {
    id: "05",
    title: "Subscriptions & loyalty",
    description:
      "Recurring billing, memberships and loyalty mechanics that lift repeat revenue.",
  },
  {
    id: "06",
    title: "Scale & performance",
    description:
      "Caching, CDN and infrastructure engineered to stay sub-second through your biggest sale day.",
  },
];
...
const outcomes = [
  {
    value: "+15 – 40%",
    label: "Conversion lift after replatform",
  },
  {
    value: "<1s",
    label: "Storefront load time",
  },
  {
    value: "Peak",
    label: "Sale-day load-tested",
  },
  {
    value: "100%",
    label: "Stack & data ownership",
  },
];
...
const principles = [
  {
    id: "01",
    title: "Conversion is the metric",
    description:
      "We instrument the funnel and optimise against completed orders — not page views or vanity speed scores.",
  },
  {
    id: "02",
    title: "Speed as strategy",
    description:
      "Headless architecture and aggressive caching keep storefronts sub-second, because slow pages are abandoned carts.",
  },
  {
    id: "03",
    title: "Sale-day proof",
    description:
      "We load-test to your peak event so flash sales and launches are a spec we hit, not a risk we hope through.",
  },
  {
    id: "04",
    title: "Own your stack",
    description:
      "No lock-in to a closed platform — you own the storefront, the data and the roadmap.",
  },
];
...
const audiences = [
  ...
  "B2B & wholesale",
  "High-traffic / flash-sale retail",
...
const faqs = [
  [
    "Will a replatform actually lift conversion?",
    "It is the point of the exercise. By cutting load time, checkout friction and search misses, replatforms we have shipped have lifted conversion by double-digit percentages — we instrument the funnel so the gain is measured, not assumed.",
  ],
  [
    "Do you build on Shopify, or fully custom?",
    "Both, depending on fit. We build headless on commerce platforms when that wins, and fully custom when your model needs it — we show you the trade-off before you commit.",
  ],
  [
    "Can you handle a multi-vendor marketplace?",
    "Yes — seller onboarding, catalogues, commissions and payouts are part of the marketplace builds we deliver.",
  ],
  [
    "Will it survive a flash sale?",
    "We load-test to your peak event and engineer caching and infrastructure to hold sub-second through it, so launch day is planned for, not feared.",
  ],
  [
    "Can we manage merchandising without engineering?",
    "A headless architecture decouples the storefront, so your team ships content and merchandising changes without waiting on a deploy.",
  ],
] as const;
      ...
      <section className="industries-hero relative overflow-hidden border-b border-[#d8dce9] px-5 pb-20 pt-8 sm:px-8 lg:px-10">
        ...
        <div className="relative z-10 mx-auto max-w-[1360px]">
          ...
          <div className="text-[13px] font-medium uppercase tracking-[.18em] text-[#7983a5]">
            ...
            <span className="text-[#ff6d50]">E-Commerce</span>
          </div>
          ...
          <div className="mt-10 inline-flex items-center gap-4 rounded-full border border-[#d8dce9] bg-white/75 px-5 py-3 shadow-sm backdrop-blur">
            ...
            <span className="text-[14px] uppercase tracking-[.18em] text-[#66728f]">
              Industry 05 / 15 — Storefronts & marketplaces
            </span>
          </div>
          ...
          <p className="mt-10 max-w-3xl text-[21px] leading-[1.7] text-[#55607f]">
            Headless storefronts and multi-vendor marketplaces engineered for
            speed, search and checkout — so more visitors become buyers, and
            sale day doesn’t take you down.
          </p>
          ...
          <div className="grid lg:grid-cols-[1.35fr_.65fr]">
            ...
            <div className="relative p-8 sm:p-12 lg:p-16">
              ...
              <h2 className="max-w-2xl text-[clamp(2.5rem,4.5vw,4.4rem)]  leading-[0.95] tracking-[-0.06em] text-[#111322] dark:text-white">
                A replatform should pay for
                <br />
                itself in conversion.
              </h2>

              <p className="mt-10 max-w-2xl text-[20px] leading-[1.75] text-[#586482] dark:text-[#b8c1da]">
                We have moved storefronts off slow, rigid platforms and onto
                fast headless stacks and seen completion rates climb by double
                digits. The playbook is unglamorous: shave load time, strip
                checkout friction, fix search relevance, and harden for the
                traffic spike. Done right, the conversion lift funds the rebuild
                — and you own every line of it afterward, stack, data and
                roadmap included.
              </p>
            </div>
      ...
      <section className="px-5 py-16 sm:px-8 lg:px-10 ">
        <div className="mx-auto grid max-w-[1360px] gap-16 lg:grid-cols-[0.95fr_1.25fr]">
          ...
          <div className="space-y-10 text-[20px] leading-[1.8] text-[#55607f] dark:text-[#b8c1da]">
            <p>
              In e-commerce, milliseconds are money. A slow storefront, a clumsy
              checkout, a search that can’t find the product — each one quietly
              bleeds conversion, and the leak only widens as traffic grows.
            </p>

            <p>
              We replatform and build commerce that{" "}
              <strong className="font-semibold text-[#111322] dark:text-white">
                moves the conversion number:
              </strong>{" "}
              fast headless storefronts, frictionless checkout, search that
              actually finds things, and infrastructure that holds through a
              flash sale instead of folding under it.
            </p>

            <p>
              Because the storefront is decoupled from the backend, your
              merchandising team ships changes without waiting on a deploy — and
              you own the stack, the data and the roadmap rather than renting
              them from a closed platform.
            </p>
          </div>
        </div>
      </section>
