...
export default function IndustriesMegaMenu({
  ...
  return (
    <motion.div
      ...
      className="absolute left-1/2 top-full z-50 mt-4 w-[min(94vw,1800px)] -translate-x-1/2 rounded-[28px] border border-[#dfe3ee] bg-[#f9faff] px-6 py-6 shadow-[0_28px_64px_rgba(38,48,86,.14)] lg:px-10 lg:py-12"
    >
